...
FEATURE_SYNONYMS = {
    ...
    "compressed final render prompt": ["create", "clean", "avoid", "preserve"],
    "priority stack": ["subject", "readable", "controlled", "main style", "avoid"],
    "clean subject": ["clean", "readable", "crisp", "silhouette", "subject edges", "主体"],
    "one main style anchor": ["one main style", "quiet editorial", "cinematic realism", "editorial", "product photography", "one subtle"],
    "controlled background": ["controlled", "uncluttered", "background"],
    "product geometry": ["product geometry", "bottle shape", "pump height", "label placement"],
    "preserve change split": ["preserve", "replace", "change"],
    "low texture noise": ["low texture noise", "subtle", "clean"],
    "identity anchors": ["face structure", "age", "expression", "hairstyle", "clothing", "pendant"],
    "parameters removed": ["create", "avoid", "product image"],
    "natural avoid language": ["avoid", "uncluttered"],
    "copy-ready prompt": ["portrait", "composition", "mood"],
    "no explanatory prose": ["portrait", "composition", "mood"],
    "wrapper named": ["comfyui", "webui", "assuming"],
    "negative prompt field": ["negative prompt field"],
    "local wrapper fields": ["wrapper fields", "lora", "controlnet", "cfg"],
